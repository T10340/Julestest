			...
			<div className="container flex h-14 items-center">
				<div className="mr-4 hidden md:flex">
					<Link href="/" className="mr-6 flex items-center space-x-2">
						...
						<span className="hidden font-semibold sm:inline-block">JUYO Finance</span>
					</Link>
				...
				<Link href="/" className="mr-6 flex items-center md:hidden">
					<Wallet className="h-6 w-6" />
					<span className="ml-2 font-semibold">JUYO Finance</span>
				</Link>
	...
	return (
		<div className="flex flex-col space-y-4 py-4">
			<Link href="/" className="flex items-center space-x-2">
				<Wallet className="h-6 w-6" />
				<span className="font-semibold">JUYO Finance</span>
			</Link>
